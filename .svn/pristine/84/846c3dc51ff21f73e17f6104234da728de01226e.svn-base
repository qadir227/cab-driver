...
public class JobScreenFragment extends LoggedInFragment implements Dialog_DriverNotes.OnJobNotesEnteredListener
{
    ...
    protected View onCreateTickingView(LayoutInflater _inflater, ViewGroup _container, Bundle _savedInstanceState)
    {
        ...
        this.btnPlay.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                //JobScreenFragment.this.startFlipping(false);
            }
        });
    ...
    /*private class StatusReceiver extends BroadcastReceiver
    {
        ...
        public void onReceive(Context _c, Intent _intent)
        {
            ...
            if(!(JobScreenFragment.this.clearPending))
            {
                JobScreenFragment.this.updateJobButtonAndSliders(j);
            }
    ...
    private class HaveYouMoved extends MileageTool
    {
        ...
        public void doCheck()
        {
            pdaLocation p = STATUSMANAGER.getCurrentLocation(JobScreenFragment.this.getContext());
            ...
            {
                if(STATUSMANAGER.getCurrentJob(JobScreenFragment.this.getContext()).getJobStatus().equals(cabdespatchJob.JOB_STATUS.ON_ROUTE))
                {
    ...
    private class MyWebViewClient extends WebViewClient
    {
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url)
        {
            try
            {
                cabdespatchJob j = STATUSMANAGER.getCurrentJob(JobScreenFragment.this.getContext());
                ...
                else
                {
                    try
                    {
                        Globals.WebTools.launchWebIntent(JobScreenFragment.this.getContext(), url);
                    }
            ...
            public void onClick(View v)
            {
                ...
                switch (action)
                {
                    ...
                    case JobButtonPressResult.ACTION_REQUEST_DRIVER_NOTES:
                        Dialog_DriverNotes dlg = new Dialog_DriverNotes(JobScreenFragment.this.getActivity(), (ViewGroup) JobScreenFragment.this.getView().findViewById(R.id.dlg_container), JobScreenFragment.this);
                    ...
                    case JobButtonPressResult.ACTION_REQUEST_PRICE:
                        ...
                        Globals.CrossFunctions.OnPriceUpdatedListener listener = new Globals.CrossFunctions.OnPriceUpdatedListener()
                        {
                            ...
                            public void onPriceUpdated()
                            {
                                ...
                                JobScreenFragment.this.btnJobStatus.setVisibility(View.INVISIBLE); //we're sending a clear so we don't want
                                //the driver to go through a loop...
                            }
                        };

                        Globals.CrossFunctions.startSimplePriceRequest(JobScreenFragment.this.getActivity(),
                                (ViewGroup) JobScreenFragment.this.getView().findViewById(R.id.dlg_container),
                                JobScreenFragment.this.getActivity().getWindow(),
                                JobScreenFragment.this.getActivity().getCurrentFocus(),
                                listener);
                        break;
                    default:
    ...
    private void showJobButtonAfter5Seconds()
    {
        new PauseAndRun()
        {
            ...
            protected void onPostExecute(Void _void)
            {
                if(!(this == null))
                {
                    if(JobScreenFragment.this.btnJobStatus.getVisibility() == View.VISIBLE)
                    {
                        //do nothing
                    }
                    else
    ...
    {
        this.btnJobStatus = (ImageButton) _v.findViewById(R.id.frmJob_btnJobButton);
        this.btnJobStatus.setOnClickListener(btnJob_Click());


        String extra = JobScreenFragment.this.getActivity().getIntent().getStringExtra(_NOJOBBUTTON);
        ...
        this.btnPanic = (ImageButton) _v.findViewById(R.id.frmJob_btnPanic);

        if(SETTINGSMANAGER.SETTINGS.USE_PANIC.parseBoolean(this.getContext()))
        {
            if(SETTINGSMANAGER.SETTINGS.LONG_PRESS_PANIC.parseBoolean(JobScreenFragment.this.getContext()))
            {
            ...
            else
            {
                this.btnPanic.setOnClickListener(new View.OnClickListener()
                {
                    ...
                    public void onClick(View v)
                    {
                        if(JobScreenFragment.this.panicArmed)
                        {
                            Globals.CrossFunctions.Panic(JobScreenFragment.this.getContext());
                        }
                        else
    ...
    private void setupViewFlipper(cabdespatchJob j)
    {
        ...
        else
        {
            ...
            {
                ErrorActivity.handleError(JobScreenFragment.this.getContext(), new ErrorActivity.ERRORS.INVALID_JOB_TIME_STRING(time, ""));
            }
        }


        this.flip.addView(this.getJobDetailView(VIEW_TYPE.TIME(JobScreenFragment.this.getContext()), time));
        String vType = j.getVehicleType();
        if(!(vType.isEmpty()))
        {
            this.flip.addView(this.getJobDetailView(VIEW_TYPE.VEHICLE_TYPE(JobScreenFragment.this.getContext()), vType));
        }

        this.flip.addView(this.getJobDetailView(VIEW_TYPE.PICKUP(JobScreenFragment.this.getContext()),j.getFromAddress(),0,(j.getJobStatus()== cabdespatchJob.JOB_STATUS.ON_ROUTE?true:false)));
        ...
        this.flip.addView(this.getJobDetailView(VIEW_TYPE.DESTINATION(JobScreenFragment.this.getContext()),j.getToAddress(), 0, (j.getJobStatus()== cabdespatchJob.JOB_STATUS.POB?true:false)));
        ...
        if(j.priceHasBeenUpdated())
        {
            ...
            this.flip.addView(this.getJobDetailView(VIEW_TYPE.PRICE(JobScreenFragment.this.getContext()),getPriceString(j), title));
        }
        else
        {
            if(j.isAccount())
            {
                this.flip.addView(this.getJobDetailView(VIEW_TYPE.PRICE(JobScreenFragment.this.getContext()),getPriceString(j)));
            }
            else
            {
                this.flip.addView(this.getJobDetailView(VIEW_TYPE.PRICE(JobScreenFragment.this.getContext()),getPriceString(j)));
        ...
        if(!(name.isEmpty()))
        {
            this.flip.addView(this.getJobDetailView(VIEW_TYPE.NAME(JobScreenFragment.this.getContext()), name));
        }

        String comments = j.getComments();
        if(!(comments.isEmpty()))
        {
            this.flip.addView(this.getJobDetailView(VIEW_TYPE.COMMENTS(JobScreenFragment.this.getContext()), comments));
        }

        String flightNo = j.getFlightNo();
        if(!((flightNo.equals("")||(flightNo.equals(cabdespatchJob.EMPTY)))))
        {
            WebView w = new WebView(JobScreenFragment.this.getContext());
    ...
    private View.OnClickListener btnPay_Click()
    {
        return new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                Boolean showAmendPrice = SETTINGSMANAGER.CreditCardPayment.priceAmendAvailable(JobScreenFragment.this.getContext());

                if(showAmendPrice)
                {
                    Dialog_GetPrice dlg = new Dialog_GetPrice(JobScreenFragment.this.getActivity(), (ViewGroup) JobScreenFragment.this.getView().findViewById(R.id.dlg_container), true);
                ...
                {
                    startTotalFareAdvice(Double.valueOf(STATUSMANAGER.getCurrentJob(JobScreenFragment.this.getContext()).getPrice()));
                }
    ...
    private void startTotalFareAdvice(Double _baseFare)
    {
        ...
        Double surcharge = cabdespatchJob.calculateSurcharge(JobScreenFragment.this.getContext(), _baseFare);
        ...
        Dialog_MsgBox_New.OnMessageBoxButtonListener l = new Dialog_MsgBox_New.OnMessageBoxButtonListener()
        {
            ...
            public void MessageBoxOKPressed()
            {
                ...
                STATUSMANAGER.setCurrentJob(JobScreenFragment.this.getContext(), j);
                JobScreenFragment.this.getHostActivity().hideKeyboard();
        ...
        new Dialog_MsgBox_New(JobScreenFragment.this.getActivity(), R.drawable.n_ico_card, (ViewGroup) JobScreenFragment.this.getActivity().findViewById(R.id.dlg_container), title, message, l).show();
    }
...
*/
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data)
    {
        ...
        {
            getHostActivity().getCreditCardHandler().processActivityResult(data, resultCode, "FJS");
        }
    }
    ...
    private void updatePriceSlide(Boolean _fromCreditCardPayment)
    {
        ...
        {
            if(v.getViewType().equals(VIEW_TYPE.PRICE(JobScreenFragment.this.getContext())));
            {
            ...
            switch(_j.getJobStatus())
            {
                ...
                case ON_ROUTE:
                    ...
                    this.btnJobStatus.setOnLongClickListener(new View.OnLongClickListener()
                    {
                        ...
                        {
                            v.setVisibility(View.INVISIBLE);
                            JobScreenFragment.this.dlg_POBSTC = new Dialog_POBSTP(JobScreenFragment.this.getContext(), null);
                            JobScreenFragment.this.dlg_POBSTC.setOnResultListener(new Dialog_POBSTP.OnResultListener()
                            {
                                ...
                                public void OnResult(Dialog_POBSTP.RESULT _result)
                                {
                                    switch (_result)
                                    {
                                        ...
                                        case POB:
                                            ...
                                            JobScreenFragment.this.getContext().sendBroadcast(Message);
                                            break;
                                        case CANCEL:
                ...
                case POB:
                    for(SliderView v:this.sliderViews)
                    {
                        if(v.getViewType()== VIEW_TYPE.DESTINATION(JobScreenFragment.this.getContext()))
                        {
                            v.showNavigateButton();
                        }
                    ...
                    if(SETTINGSMANAGER.CreditCardPayment.isEnabled(JobScreenFragment.this.getContext()))
                    {

                        if(STATUSMANAGER.getCurrentJob(JobScreenFragment.this.getContext()).isCash())
                        {
                ...
                case STC:
                    ...
                    this.btnJobStatus.setOnLongClickListener(new View.OnLongClickListener()
                    {
                        ...
                        {
                            v.setVisibility(View.INVISIBLE);
                            JobScreenFragment.this.dlg_ClearBreak = new Dialog_CLEARBREAK(JobScreenFragment.this.getContext());
                            JobScreenFragment.this.dlg_ClearBreak.setOnResultListener(new Dialog_CLEARBREAK.OnResultListener()
                            {
    ...
    public void onBroadcastReceived(Context _context, Intent _intent)
    {
        ...
        if(_intent.getAction().equals(BROADCASTERS.PLOT_UPDATED))
        {
            ...
            if(JobScreenFragment.this.oNudger.shouldNudge(j, currentPlot.getShortName()))
            {
            ...
            if(STATUSMANAGER.getBoolean(_context, STATUSMANAGER.STATUSES.ON_RANK))
            {
                ...
                else
                {
                    ...
                    try
                    {
                        ...
                        JobScreenFragment.this.flip.setVisibility(View.VISIBLE);
...
//	}
    ...
    private View getJobDetailView(final String _viewType, final String _detail, int _viaCount, boolean _showNavigate, String _toLat, String _toLon, String _titleOverride)
    {
                ...
                */
                ...
                if (isEllipsised)
                {
                    btnPopOut.setOnClickListener(new View.OnClickListener()
                    {
                        ...
                        public void onClick(View v)
                        {
                            TextView t = new TextView(JobScreenFragment.this.getActivity());
                            t.setText(detailText);
                            t.setTextSize(JobScreenFragment.this.getResources().getDimensionPixelSize(R.dimen.job_detail_popout));

                            Dialog_PopOut d = new Dialog_PopOut(JobScreenFragment.this.getActivity(), t);
                            d.show();
                        }
                    });
        ...
        else if (_viewType.equals(VIEW_TYPE.TIME(JobScreenFragment.this.getContext())))
        {
            title.setText("Time");
        }
        else if (_viewType.equals(VIEW_TYPE.DESTINATION(JobScreenFragment.this.getContext())))
        {
        ...
        else if (_viewType.equals(VIEW_TYPE.PICKUP(JobScreenFragment.this.getContext())))
        {
            btnSpeak.setTag(detailText);
            btnSpeak.setOnClickListener(new View.OnClickListener()
            {
        ...
        else if (_viewType.equals(VIEW_TYPE.PRICE(JobScreenFragment.this.getContext())))
        {
            title.setText("Price");
        ...
        else if (_viewType.equals(VIEW_TYPE.COMMENTS(JobScreenFragment.this.getContext())))
        {
            title.setText("Notes");
        } else if (_viewType.equals(VIEW_TYPE.NAME(JobScreenFragment.this.getContext())))
        {
            btnSpeak.setTag(detailText);
            btnSpeak.setOnClickListener(new View.OnClickListener()
            {
        ...
        else if (_viewType.equals(VIEW_TYPE.VEHICLE_TYPE(JobScreenFragment.this.getContext())))
        {
            ...
            public boolean onTouch(View v, MotionEvent touchevent)
            {
                ...
                switch (touchevent.getAction())
                {
                    ...
                    case MotionEvent.ACTION_UP:
                        ...
                        if (lastX < currentX)
                        {
                            vf.setInAnimation(JobScreenFragment.this.getContext(), R.anim.in_from_left);
                            vf.setOutAnimation(JobScreenFragment.this.getContext(), R.anim.out_to_right);
                            vf.showPrevious();
                            this.lastX = -1;
                            return true;
                        }
                        ...
                        if (lastX > currentX)
                        {
                            vf.setInAnimation(JobScreenFragment.this.getContext(), R.anim.in_from_right);
                            vf.setOutAnimation(JobScreenFragment.this.getContext(), R.anim.out_to_left);
                            vf.showNext();
                            this.lastX = -1;
                            return true;
                        }
    ...
    private void startFlipping(boolean _showNext)
    {
        ...
        this.flip.setInAnimation(JobScreenFragment.this.getContext(), R.anim.in_from_right);
        this.flip.setOutAnimation(JobScreenFragment.this.getContext(), R.anim.out_to_left);
        if(_showNext)
        {
            this.flip.showNext();
        }
    ...
    private class SliderView
    {
                          ...
                          final String _toLat, final String _toLon)
        {
            ...
            if(_showButton)
            {
                if(SETTINGSMANAGER.navigationAvailable(JobScreenFragment.this.getContext()))
                {
    ...
    public void armPanic()
    {
        ...
        Globals.CrossFunctions.armPanic(this.btnPanic, this.getActivity(), new Globals.UnarmPanicListener()
        {
