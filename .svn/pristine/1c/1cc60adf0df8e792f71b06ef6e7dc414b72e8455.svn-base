 ...
 */
public class DriverScreenFragmentNGX extends LoggedInFragment implements ViewTreeObserver.OnGlobalLayoutListener {


    public DriverScreenFragmentNGX()
    {
    ...
    private ViewGroup btnPanic;
    private ViewGroup btnPlot;
    ...
    protected View onCreateTickingView(LayoutInflater _inflater, ViewGroup _container, Bundle _savedInstanceState)
    {
        ...
        this.btnPlot =  v.findViewById(R.id.frmDriver_btnJobButton);
        ...
        btnPlot.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                Intent i = new Intent(DriverScreenFragmentNGX.this.getContext(), PlotList.class);
                i.setAction(PlotList.ACTION_SEND_PLOT_UPDATE);
                Globals.StartActivity(DriverScreenFragmentNGX.this.getContext(),i);
        ...
        btnMenu.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                DriverScreenFragmentNGX.this.showMenu();
            }
        });

        this.btnPanic = v.findViewById(R.id.frmDriver_btnPanic);
        if(SETTINGSMANAGER.SETTINGS.USE_PANIC.parseBoolean(this.getContext()))
        {
            ...
            {
                this.btnPanic.setBackgroundResource(R.color.button_background_panic_armed);
                this.btnPanic.setOnLongClickListener(new View.OnLongClickListener()
                {
                    @Override
                    public boolean onLongClick(View v)
                    {
                        Globals.CrossFunctions.Panic(DriverScreenFragmentNGX.this.getContext());
                        return true;
                    }
                });
            }
            else
            {
                this.btnPanic.setOnClickListener(new View.OnClickListener()
                {
                    ...
                    public void onClick(View v)
                    {
                        if(DriverScreenFragmentNGX.this.panicArmed)
                        {
                            Globals.CrossFunctions.Panic(DriverScreenFragmentNGX.this.getContext());
                        }
                        else
                        {
                            DriverScreenFragmentNGX.this.panicArmed = true;
                            Globals.CrossFunctions.armPanic(DriverScreenFragmentNGX.this.btnPanic, DriverScreenFragmentNGX.this.getActivity(), new Globals.UnarmPanicListener()
                            {

                                @Override
                                public void unarmPanic()
                                {
                                    DriverScreenFragmentNGX.this.panicArmed = false;
                                }
                            });
                        }
                    }
        ...
        this.flipOut.setAnimationListener(new Animation.AnimationListener()
        {
            ...
            {
                //DriverScreenFragmentNGX.this.canFlip = true;
            }
		...
		btnCarsWork.setOnClickListener(new View.OnClickListener()
		{
			...
			public void onClick(View v)
			{
				if(DriverScreenFragmentNGX.this.canFlip)
				{
					DriverScreenFragmentNGX.this.canFlip = false;
					DriverScreenFragmentNGX.this.flip.showNext();
				}
        ...
        this.oAdapterCars = new DriverScreenFragmentNGX.PlotAndCountAdapter(this.oListCars.getParamList());
        ...
        lstWork.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            ...
            public void onItemClick(AdapterView<?> adapter, View v, int position, long arg3)
            {
                ...
                String longPlot = SETTINGSMANAGER.getPlotsAll(DriverScreenFragmentNGX.this.getContext()).getPlotByShortName(shortPlot).getLongName();

                BROADCASTERS.Bid(DriverScreenFragmentNGX.this.getContext(),shortPlot,"s");

                cdToast.show(v.getContext(), "Bid sent for: " + longPlot, "Bid Sent", Toast.LENGTH_LONG);

                DriverScreenFragmentNGX.this.oListWork = new ArrayList<String>();
                DriverScreenFragmentNGX.this.oAdapterWork.setWorkList(DriverScreenFragmentNGX.this.oListWork);
                DriverScreenFragmentNGX.this.oAdapterWork.notifyDataSetChanged();
        ...
        RadioButton radShowCars = (RadioButton) v.findViewById(R.id.frmDriver_btnShowCars);
        radShowCars.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener()
        {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked)
            {
                if(isChecked)
                {
                    DriverScreenFragmentNGX.this.flip.setDisplayedChild(1);
                }
            }
        });
        ...
        radShowBids.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener()
        {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked)
            {
                if(isChecked)
                {
                    DriverScreenFragmentNGX.this.flip.setDisplayedChild(0);
                }
            }
        ...
        //CLAY
        //IMPORTANT! This doesn't include changes to bid on future work
        ...
        if(Boolean.valueOf(SETTINGSMANAGER.SETTINGS.SHOW_FUTURE_JOBS.getValue(this.getContext())))
        {
            radShowFutureJobs.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener()
            {
                ...
                public void onCheckedChanged(CompoundButton buttonView, boolean isChecked)
                {
                    if(isChecked)
                    {
                        DriverScreenFragmentNGX.this.prgFutureWork.setVisibility(View.VISIBLE);
                        BROADCASTERS.FutureJobs(DriverScreenFragmentNGX.this.getContext());
                        DriverScreenFragmentNGX.this.flip.setDisplayedChild(2);
                    }
                }
    ...
    public void onBroadcastReceived(Context _context, Intent _intent)
    {
        ...
        {
            DriverScreenFragmentNGX.this.onCarsWorkMessage(_context);
        }
        else if (_intent.getAction().equals(BROADCASTERS.FUTURE_JOBS_UPDATE))
        {
            DriverScreenFragmentNGX.this.onFutureJobsMessage(_context);
        }
        else if(_intent.getAction().equals(BROADCASTERS.LOCATION_UPDATED))
        {
            ...
            DriverScreenFragmentNGX.this.onLocationChange(p, true, force);
        }
    }
    ...
    protected void onLocationChange(pdaLocation _p, Boolean _doNotify, boolean _force)
    {
        ...
        if((doStuff) || (_force))
        {
            ...
            if(false)
            {
                ...
                {
                    cdToast.showLong(DriverScreenFragmentNGX.this, "Could not write to debug");
                }*/
    ...
    {
        AppCompatTextView t1 = (AppCompatTextView)  btnPanic.getChildAt(1);
        AppCompatTextView t2 = (AppCompatTextView)  btnPlot.getChildAt(1);
        AppCompatTextView t3 = (AppCompatTextView) layRank.getChildAt(0);
        Globals.CrossFunctions.makeUniformButtonTextSize(t1, t2, t3);
    }
    ...
    private class PlotAndCountAdapter extends BaseAdapter
    {
        ...
        {
            //CLAY!
            LinearLayout l = (LinearLayout) DriverScreenFragmentNGX.this.getActivity().getLayoutInflater().inflate(R.layout.row_cars, null);
            ...
            String longPlotName = DriverScreenFragmentNGX.this.oPlots.getPlotByShortName(shortPlotName).getLongName();
    ...
    private class WorkAdapter extends BaseAdapter
    {
        ...
        {
            //CLAY!
            LinearLayout l = (LinearLayout) DriverScreenFragmentNGX.this.getActivity().getLayoutInflater().inflate(R.layout.row_plot, null);
